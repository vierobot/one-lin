...
void send_frame() {
  ...
  uint8_t tx_data[12];
  static uint16_t speed = 20;
  uint16_t disp_speed = speed * 13.4;

  // Fill tx_data array
  tx_data[0] = 0x08;   // Device code (fixed)
  tx_data[1] = 0x61;   // Sequence code (fixed)
  tx_data[2] = 0x00;   // Example tx_data
  tx_data[3] = 0x00;   // Example tx_data
  tx_data[4] = 0x00;   // Example tx_data
  tx_data[5] = 0x00;   // Example tx_data
  tx_data[6] = 0x00;   // Example tx_data
  tx_data[7] = (disp_speed >> 8);   // Example tx_data
  tx_data[8] = (disp_speed & 0xff);   // Example tx_data
  tx_data[9] = 0x00;   // Example tx_data
